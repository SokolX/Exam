...
${OBJECTDIR}/bind_to_port.o: bind_to_port.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/bind_to_port.o bind_to_port.c

${OBJECTDIR}/catch_signal.o: catch_signal.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/catch_signal.o catch_signal.c

${OBJECTDIR}/hold_api.o: hold_api.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/hold_api.o hold_api.c

${OBJECTDIR}/komunikat_error.o: komunikat_error.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/komunikat_error.o komunikat_error.c
...
${OBJECTDIR}/open_listener_socket.o: open_listener_socket.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/open_listener_socket.o open_listener_socket.c

${OBJECTDIR}/read_in.o: read_in.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/read_in.o read_in.c

${OBJECTDIR}/say.o: say.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/say.o say.c

${OBJECTDIR}/src/handlingClient.o: src/handlingClient.c 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.c) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/handlingClient.o src/handlingClient.c
...
${OBJECTDIR}/src/socketUtils.o: src/socketUtils.c 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.c) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/socketUtils.o src/socketUtils.c
